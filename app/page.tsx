...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden pt-16">
      ...
      {/* Header Navigation */}
      <header className="relative z-10 flex items-center justify-between px-4 sm:px-6 py-4 lg:px-12 fixed top-0 w-full bg-black/80 backdrop-blur-sm">
      ...
      <div className="absolute top-32 right-6 md:right-12 flex flex-col gap-2">
        <Link href="/profile" className="text-white/70 hover:text-white transition-colors text-xs md:text-sm">
          Profile
        </Link>
        <Link href="/resume" className="text-white/70 hover:text-white transition-colors text-xs md:text-sm">
          Resume
        </Link>
        <Link href="/analyzer" className="text-white/70 hover:text-white transition-colors text-xs md:text-sm">
          Analyzer
        </Link>
        <Link href="/portfolio" className="text-white/70 hover:text-white transition-colors text-xs md:text-sm">
          Portfolio
        </Link>
      </div>
    </div>
